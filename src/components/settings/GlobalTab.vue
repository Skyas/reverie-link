...
.models-empty code, .models-empty p code { font-size: 12px; background: var(--c-pink-light); padding: 1px 6px; border-radius: 4px; }
...
.model-active-badge {
    font-size: 10px; font-weight: 600; color: white; background: var(--c-blue);
...
.model-display-settings {
    ...
    border: 1.5px solid var(--c-border); border-radius: 12px; margin-top: 4px;
}
.zoom-input-row { display: flex; align-items: center; gap: 8px; }
.zoom-input-row .field-range { flex: 1; }
.zoom-value { font-size: 12px; font-weight: 600; color: var(--c-text); min-width: 38px; text-align: right; flex-shrink: 0; }
...
.size-card {
    ...
    text-align: center; cursor: pointer; background: var(--c-surface);
    transition: border-color 0.2s, box-shadow 0.2s;
}
.size-card:hover  { border-color: var(--c-pink-mid); }
.size-card.active { border-color: var(--c-blue); box-shadow: 0 0 0 3px var(--c-blue-light); }
.size-label { font-size: 13px; font-weight: 600; color: var(--c-text); }
.size-desc  { font-size: 11px; color: var(--c-text-soft); margin-top: 2px; }

/* 记忆窗口 */
.memory-window-options { display: flex; flex-direction: column; gap: 6px; }
.memory-window-card {
    display: flex; align-items: center; gap: 10px;
    padding: 10px 14px; border: 1.5px solid var(--c-border);
    border-radius: 10px; cursor: pointer; background: var(--c-surface);
    transition: border-color 0.2s, box-shadow 0.2s;
}
.memory-window-card:hover  { border-color: var(--c-pink-mid); }
.memory-window-card.active {
    border-color: var(--c-blue); box-shadow: 0 0 0 3px var(--c-blue-light);
    background: linear-gradient(135deg, rgba(197,232,244,0.15), rgba(255,183,197,0.1));
}
.memory-window-label { font-size: 13px; font-weight: 600; color: var(--c-text); min-width: 80px; flex-shrink: 0; }
.memory-window-desc  { font-size: 12px; color: var(--c-text-soft); flex: 1; }
.memory-window-token { font-size: 11px; color: var(--c-text-soft); text-align: right; flex-shrink: 0; }
